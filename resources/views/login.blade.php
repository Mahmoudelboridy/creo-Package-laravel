    ...
    <div class="col-lg-12 col-xl-6">
        <form action="" method="POST">
            ...
            <div class="text-center">
                ...
                <p class="fw-bold mb-0" style="font-size:18pt">Don't have an account? <a style="text-decoration:none"
                        href="signup">sign up</a></p>
                        <a style="font-size:18pt;text-decoration:none" href="{{route('forget')}}" class="fw-bold mb-0">forget password</a>
            </div>
        </form>
    </div>
</div>
